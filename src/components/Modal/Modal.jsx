...
const Modal = () => {
    ...
    useEffect(() => {
        ...
        const handleEvent = (e) => {
            switch (e.type) {
                ...
                case 'error':
                    console.log(e);
                    return toast.error('something doesnt work')
                default:
                    return
            }
        }
    ...
    const handleUploadPost = async () => {
        ...
        const toastId = toast.loading('The post is published...')
                                        ...
                                        {!file ?
                                            ...
                                            (
                                                <div className='dialog__image'>
                                                    ...
                                                    <input value={media.caption} onChange={(e) => setMedia((prev) => ({ ...prev, caption: e.target.value }))} type="text" name='caption' id='caption' className='caption__input' placeholder='add description' />
